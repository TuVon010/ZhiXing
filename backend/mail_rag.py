...
from .mail_store import initialize,require,validate_accounts
...
def index_message(db,ident,attachment_root=None):
    ...
    from .mail_attachments import extract
...
def search(db,request,frozen_version=None):
    from .mail_models import SearchRequest
    import numpy as np
