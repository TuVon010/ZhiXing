"""Single language-model gateway for planning, perception and Agent decisions.

All calls pass through this module so budgets, usage, pricing snapshots and
Trace events cannot be bypassed by a feature module.
"""
...
from backend.app.observability.billing import snapshot, estimate
