...
from backend.app.modules.mail.schemas import PerceptionResult, PerceptionFeedback
...
def _create_todo_candidates(db, account_id: str, message_id: str, todos: list,
    ...
    for todo in todos:
        ...
        try:
            ...
            pass
        from backend.app.modules.mail.work_items import todo_decision, POLICY_VERSION
...
def _create_calendar_candidates(db, account_id: str, message_id: str, events: list,
    ...
    """
    from backend.app.modules.mail.calendar import create_calendar_candidate
    from backend.app.modules.mail.work_items import calendar_decision
    for event in events:
